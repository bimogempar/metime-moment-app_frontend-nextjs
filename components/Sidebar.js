    ...
    return (
        <div className="bg-white rounded-xl col-span-3 lg:block hidden p-5 h-min sticky top-10">
            ...
            <div className="text-center">
                <h1 className="text-xl mt-4 font-light break-word">{userContext.userData.name}</h1>
                <h1 className="text-md text-gray-500 mb-1 font-light break-all">{userContext.userData.username}</h1>
                <h3 className="text-md text-gray-500 mb-1 font-light break-all">081898475675</h3>
                <h1 className="text-md text-gray-500 mb-5 font-light break-all">{userContext.userData.email}</h1>
                <a className="bg-yellow-200 px-5 py-3 w-full text-center lg:w-auto rounded-lg text-yellow-600 text-xs tracking-wider font-semibold uppercase">
                    {userContext.userData.role == 2 && "Admin" || userContext.userData.role == 1 && "Employee"}
                </a>
                <NavLink />
            </div>
        </div>
